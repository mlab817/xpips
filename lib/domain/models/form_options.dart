...
part 'form_options.freezed.dart';
part 'form_options.g.dart';

@freezed
class FormOptions with _$FormOptions {
  factory FormOptions({
    ...
    @JsonKey(name: "provinces") List<Option>? provinces,
    ...
    @JsonKey(name: "attachment_types") List<Option>? attachmentTypes,
  }) = _FormOptions;
